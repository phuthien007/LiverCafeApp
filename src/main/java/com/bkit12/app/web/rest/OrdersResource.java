...
import com.bkit12.app.service.OrdersService;
...
/**
 * REST controller for managing {@link com.bkit12.app.domain.Orders}.
 */
@RestController
@RequestMapping("/api")
public class OrdersResource {
    ...
    private static final String ENTITY_NAME = "cafeAppOrders";
    ...
    public ResponseEntity<List<OrdersDTO>> getAllOrders(
        ...
        if ("workingspaceform-is-null".equals(filter)) {
            log.debug("REST request to get all Orderss where workingSpaceForm is null");
            return new ResponseEntity<>(ordersService.findAllWhereWorkingSpaceFormIsNull(), HttpStatus.OK);
        }
