...
class RolesResourceIT {
    ...
    private static final RoleTypes DEFAULT_TYPE = RoleTypes.ROLE_ADMIN;
    private static final RoleTypes UPDATED_TYPE = RoleTypes.ROLE_EMPLOYEE;
    ...
    public static Roles createEntity(EntityManager em) {
        Roles roles = new Roles().type(DEFAULT_TYPE).description(DEFAULT_DESCRIPTION);
        return roles;
    }
    ...
    public static Roles createUpdatedEntity(EntityManager em) {
        Roles roles = new Roles().type(UPDATED_TYPE).description(UPDATED_DESCRIPTION);
        return roles;
    }
    ...
    void createRoles() throws Exception {
        ...
        assertThat(testRoles.getType()).isEqualTo(DEFAULT_TYPE);
    ...
    void putNewRoles() throws Exception {
        ...
        updatedRoles.type(UPDATED_TYPE).description(UPDATED_DESCRIPTION);
        ...
        Roles testRoles = rolesList.get(rolesList.size() - 1);
        assertThat(testRoles.getType()).isEqualTo(UPDATED_TYPE);
    ...
    void fullUpdateRolesWithPatch() throws Exception {
        ...
        partialUpdatedRoles.type(UPDATED_TYPE).description(UPDATED_DESCRIPTION);
